...
class Vehiculo extends Model
{
    ...
    /**
 * Catálogo de los 8 íconos predeterminados disponibles para el mapa.
 * Fuente única de verdad: se usa tanto en el selector del formulario
 * como en el JS del mapa en vivo (vía Illuminate\Support\Js::from()).
 */
public const ICONOS = [
    'sedan' => [
        'label' => 'Sedán',
