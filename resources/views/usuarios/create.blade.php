...
<div x-show="openCreate" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div x-show="openCreate"
        ...
        <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 shrink-0">
            <h2 class="text-lg font-bold text-gray-800">Registrar Nuevo Usuario</h2>
        ...
        <!-- Formulario -->
        <form action="{{ route('usuarios.store') }}" method="POST" class="p-6 space-y-6 overflow-y-auto">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}" required class="bg-gray-50 border {{ $errors->has('nombre') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                ...
                <div>
                    ...
                    <input type="text" name="apellido_paterno" value="{{ old('apellido_paterno') }}" required class="bg-gray-50 border {{ $errors->has('apellido_paterno') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                ...
                <div>
                    ...
                    <input type="text" name="apellido_materno" value="{{ old('apellido_materno') }}" class="bg-gray-50 border {{ $errors->has('apellido_materno') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required class="bg-gray-50 border {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                ...
                <div>
                    ...
                    <input type="text" name="telefono" value="{{ old('telefono') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                </div>

                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900">Rol del Sistema</label>
                    <select name="role" required class="bg-gray-50 border {{ $errors->has('role') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                ...
                <div>
                    ...
                    <input type="password" name="password" required class="bg-gray-50 border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    @error('password') <span class="text-xs text-red-600 mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div class="flex items-center pt-8">
                    <input type="checkbox" name="activo" value="1" {{ old('activo', true) ? 'checked' : '' }} class="w-4 h-4 text-gray-900 bg-gray-100 border-gray-300 rounded focus:ring-gray-900">
            ...
            <div x-data="{ openDireccion: {{ old('direccion.calle') || $errors->has('direccion.*') ? 'true' : 'false' }} }" class="pt-2 border-t border-gray-100">
                ...
                <div x-show="openDireccion" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" style="display: none;" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-3 pb-2">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="direccion[calle]" value="{{ old('direccion.calle') }}" class="bg-gray-50 border {{ $errors->has('direccion.calle') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion[numero_exterior]" value="{{ old('direccion.numero_exterior') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    </div>

                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Número Interior</label>
                        <input type="text" name="direccion[numero_interior]" value="{{ old('direccion.numero_interior') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    </div>

                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Colonia</label>
                        <input type="text" name="direccion[colonia]" value="{{ old('direccion.colonia') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    </div>

                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Código Postal</label>
                        <input type="text" name="direccion[codigo_postal]" value="{{ old('direccion.codigo_postal') }}" class="bg-gray-50 border {{ $errors->has('direccion.codigo_postal') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion[ciudad]" value="{{ old('direccion.ciudad') }}" class="bg-gray-50 border {{ $errors->has('direccion.ciudad') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion[estado]" value="{{ old('direccion.estado') }}" class="bg-gray-50 border {{ $errors->has('direccion.estado') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="direccion[referencias]" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5">{{ old('direccion.referencias') }}</textarea>
                    </div>
                </div>
            </div>
